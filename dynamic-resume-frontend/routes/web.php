...
// Builder Skills step
Route::get('/builder/skills', function () {
    return view('builder.skills');
});

// Builder Summary step
Route::get('/builder/summary', function () {
    return view('builder.summary');
});
...
Route::get('/builder/finalize', function () {
    return view('builder.finalize');
});