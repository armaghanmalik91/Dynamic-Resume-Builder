...
<!-- GHOST FINAL PATCH: Work History intro/detail template same small size as Skills intro; location/buttons/old logic untouched -->
<style id="ghost-work-template-same-small-size-location-final">
    /* Only Work History intro/detail template size is adjusted. Blue sidebar, text, buttons and logic unchanged. */
    .work-main.detail-mode .template-preview-frame {
    ...
    .work-main.detail-mode .mock-resume-inner {
        padding: 26px 38px !important;
    }

    .work-main.detail-mode .mock-top-bar {
        height: 11px !important;
    }

    .work-main.detail-mode .mock-name {
        font-size: 15.5px !important;
        margin-bottom: 2px !important;
    }

    .work-main.detail-mode .mock-role {
        font-size: 7px !important;
        margin-top: 2px !important;
    }

    .work-main.detail-mode .mock-contact {
        font-size: 6px !important;
        margin-top: 10px !important;
    }

    .work-main.detail-mode .mock-line {
        margin: 6px 0 8px !important;
    }

    .work-main.detail-mode .mock-section-title,
    .work-main.detail-mode .mock-work-title {
        font-size: 9px !important;
        margin: 6px 0 5px !important;
    }

    .work-main.detail-mode .mock-small,
    .work-main.detail-mode .mock-bullets,
    .work-main.detail-mode .mock-bullets li {
        font-size: 6px !important;
        line-height: 1.32 !important;
    }

    .work-main.detail-mode .mock-skills {
        gap: 4px 14px !important;
        margin-top: 6px !important;
    }

    .work-main.detail-mode .mock-work {
    ...
    .work-main.detail-mode .mock-job-row {
        gap: 8px !important;
        margin: 5px 0 !important;
    }

    .work-main.detail-mode .mock-job-title {
        font-size: 7px !important;
    }

    .work-main.detail-mode .mock-date {
        font-size: 6px !important;
    }
    ...
    .work-main.detail-mode .work-highlight-box {
        left: 3% !important;
        right: 3% !important;
        top: 41% !important;
...
<!-- GHOST FINAL PATCH: Work History intro Go Back + text size only. Blue/sidebar/template/buttons/logic untouched. -->
<style id="ghost-work-intro-goback-text-size-only-final">
    /* Go Back: keep it between Resume Builder and Heading, add underline */
    .work-main:not(.job-form-mode):not(.work-info-mode):not(.work-summary-mode) .top-back,
    body .work-main:not(.job-form-mode):not(.work-info-mode):not(.work-summary-mode) a.top-back#topBackLink {
        top: 78px !important;
        left: 48px !important;
        font-size: 18px !important;
        font-weight: 900 !important;
    ...
    .work-main:not(.job-form-mode):not(.work-info-mode):not(.work-summary-mode) .top-back i,
    body .work-main:not(.job-form-mode):not(.work-info-mode):not(.work-summary-mode) a.top-back#topBackLink i {
        text-decoration: none !important;
    }

    /* Intro/detail text: Education-page style smaller size only */
    .work-main.detail-mode .detail-copy {
        padding-top: 0 !important;
    }

    .work-main.detail-mode .detail-title {
    ...
    .work-main.detail-mode .detail-strong {
        font-size: 22px !important;
    ...
    .work-main.detail-mode .detail-text {
        font-size: 22px !important;
...
<body>
    ...
    <script>
        ...
        const TEMPLATE_API_BASE = 'https://resume-backend-54se.onrender.com';
...
(function(){
    ...
    function ensureBackPosition(){
        ...
        if(wm.classList.contains('work-summary-mode')){
            ...
            back.style.setProperty('margin','28px 0 34px 0','important');
...
<!-- GHOST FINAL PATCH: Work History summary Go Back + Job form title size only. Blue/sidebar/template/buttons/logic untouched. -->
<style id="ghost-work-summary-job-form-title-final-fix">
    /* Summary page Go Back: underline only, no sidebar/template/button change */
    .work-main.work-summary-mode .top-back,
    body .work-main.work-summary-mode a.top-back#topBackLink {
        color: #2563eb !important;
        font-size: 18px !important;
    ...
    .work-main.work-summary-mode .top-back i,
    body .work-main.work-summary-mode a.top-back#topBackLink i {
        text-decoration: none !important;
    }

    /* Tell us about your most recent job: Education intro/detail style size */
    .work-main.job-form-mode .job-form-header {
    ...
    .work-main.job-form-mode .job-form-subtitle {
        font-size: 22px !important;
        line-height: 1.42 !important;
        font-weight: 400 !important;
        color: #071022 !important;
...
<!-- GHOST FINAL PATCH: Job form Go Back underline + Summary Go Back slightly lower only. No old logic changed. -->
<style id="ghost-work-goback-final-user-only">
    /* Tell us about your most recent job page: underline Go Back only */
    .work-main.job-form-mode .top-back,
    body .work-main.job-form-mode a.top-back#topBackLink {
        text-decoration: underline !important;
        text-underline-offset: 2px !important;
        text-decoration-thickness: 1.5px !important;
        color: #2563eb !important;
    ...
    .work-main.job-form-mode .top-back i,
    body .work-main.job-form-mode a.top-back#topBackLink i {
        text-decoration: none !important;
    }

    /* Work history summary page: move Go Back slightly lower only */
    .work-main.work-summary-mode .top-back,
    body .work-main.work-summary-mode a.top-back#topBackLink {
